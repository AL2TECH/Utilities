...
columns = ['Item', 'Qty', 'Reference(s)', 'Value', 'Description', 'Footprint', 'Datasheet', 'Rating', 'Tolerance', 'Manufacturer', 'Manufacturer PN', 'Supplier', 'Supplier PN', 'Supplier Link', 'Assembly Option']
...
for group in grouped:
    ...
    for component in group:
		...
		if component.getField('Assembly Option') != 'Not Fitted' :
			if len(refs) > 0:
				refs += ", "
